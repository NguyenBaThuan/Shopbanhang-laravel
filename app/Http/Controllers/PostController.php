...
class PostController extends Controller
{
    ...
    public function all_post(){
    	...
    	$all_post = Post::with('cate_post')->orderBy('cate_post_id')->paginate(5);
    ...
    public function danh_muc_bai_viet(Request $request,$post_slug){
        ...
        return view('pages.baiviet.danhmucbaiviet',compact('cate_product','category_post','share_image','brand_product','meta_keywords','meta_title','url_canonical','meta_desc','slider','post_cate'));
    }
    public function bai_viet(Request $request,$post_slug){
        ...
        return view('pages.baiviet.baiviet',compact('cate_product','category_post','share_image','brand_product','meta_keywords','meta_title','url_canonical','meta_desc','slider','related','post_by_id'));
    }
}
