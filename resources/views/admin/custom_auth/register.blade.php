        ...
        <div class="w3layouts-main">
            ...
            <form action="{{url('/register')}}" method="post">
                ...
                @foreach($errors->all() as $error)
                    {{$error}}
                @endforeach
                <input type="text" class="ggg" name="admin_name" value="{{old('admin_name')}}" placeholder="Nhập tên">
                <input type="text" class="ggg" name="admin_email" value="{{old('admin_email')}}" placeholder="Nhập email">
                <input type="text" class="ggg" name="admin_phone" value="{{old('admin_phone')}}" placeholder="Nhập SĐT">
